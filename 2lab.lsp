...
(defun del_idx (x y &optional (n 1)) (cond ((null x) nil) ((null y) x) ((= (car y) n) (del_idx (cdr x) (cdr y) (1+ n))) (t (cons (car x) (del_idx (cdr x) y (1+ n))))))

(print (del_idx `( a s d f g h j k l) `(1 4 5 8)))